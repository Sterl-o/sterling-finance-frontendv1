      ...
      <div className={classes.container}>
          ...
          <div className={classes.layoutPromoMoreWrapper}>
            <div className={classes.layoutPromoMore} onClick={handleScroll}>
              ...
              <span>
                ...
                >
                  <path
                    d="M15.4999 16.465L21.6874 10.2775L23.4549 12.045L15.4999 20L7.54492 12.045L9.31242 10.2775L15.4999 16.465Z"
                    fill="#86B9D6"
                  />
                </svg>
              </span>
        ...
        <div className={classes.layoutDescription} ref={layoutRef}>
          ...
          <div className={classes.layoutDescriptionText}>
            <p>
              Sterling officially launched with a collective goal of{" "}
              <b>fair and balanced access to DeFi</b>.
            </p>
            <p>
              Sterling is a decentralized exchange that has launched on Arbitrum
          ...
          <div className={classes.layoutDescriptionSmallText}>
            <p>
              ...
              assets. Sterling offers users quick, seamless and cheap
              transactions.
            </p>
          </div>
