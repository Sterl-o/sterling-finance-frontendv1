export const routerABI = [
  ...
  },
  {
    inputs: [
      { internalType: "uint256[]", name: "amounts", type: "uint256[]" },
      {
        ...
        internalType: "struct StrRouter01.Route[]",
        name: "routes",
        type: "tuple[]",
      },
      { internalType: "address", name: "to", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "amountETHMin", type: "uint256" },
      {
        ...
        internalType: "struct StrRouter01.SwapDest",
        name: "swapDest",
        type: "tuple",
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint16", name: "feeSetting", type: "uint16" },
    ],
    name: "getAmountOut",
    outputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "approveMax", type: "bool" },
      {
        ...
        internalType: "struct StrRouter01.PermitParams",
        name: "permitParams",
        type: "tuple",
      },
    ],
