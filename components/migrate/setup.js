...
export default function Setup() {
  ...
  const [sterlingPair, setsterlingPair] = useState(null);
  ...
  const callQuoteAddLiquidity = async (
    ...
    let res = await routerContract.methods
      .quoteAddLiquidity(addy0, addy1, isStable, isStable ? 5000 : 500, sendAmount0, sendAmount1)
      .call();
              ...
              >
                ...
                >
                  <path
                    ...
                    fill={appTheme === "dark" ? "#7C838A" : "#bb4f4f"}
                  />
                </svg>
              </div>
            </div>
